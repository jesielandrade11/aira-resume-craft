...
const PACKAGES = [
  ...
  },
  {
    ...
    icon: Zap,
    popular: true,
    features: ['100 gerações de currículo', 'Economia de 60%', 'Créditos nunca expiram', 'Suporte prioritário'],
  },
  {
    id: 'credits_300',
    name: '300 Créditos',
    ...
    icon: Crown,
    popular: false,
    features: ['300 gerações de currículo', 'Economia de 83%', 'Créditos nunca expiram', 'Suporte VIP'],
  },
];
