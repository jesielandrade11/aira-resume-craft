...
const PACKAGES = [
  {
    ...
    icon: Sparkles,
    popular: false,
    features: ['30 gerações de currículo', 'Suporte por chat'],
  },
  {
    id: 'credits_100',
    name: '100 Créditos',
    ...
    icon: Zap,
    popular: true,
    features: ['100 gerações de currículo', 'Economia de 17%', 'Suporte prioritário'],
  },
  {
    id: 'credits_300',
    name: '300 Créditos',
    ...
    icon: Crown,
    popular: false,
    features: ['300 gerações de currículo', 'Economia de 44%', 'Suporte VIP'],
  },
];
